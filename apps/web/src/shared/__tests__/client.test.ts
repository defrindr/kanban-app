...
describe('apiClient', () => {
  it('returns parsed success response', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(`${API_URL}/users/me`, expect.objectContaining({
  ...
  it('passes custom headers', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(`${API_URL}/boards`, expect.objectContaining({
