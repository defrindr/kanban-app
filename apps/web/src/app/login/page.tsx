...
export default function LoginPage() {
  const [email, setEmail] = useState('demo@kanbanpro.com')
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-[#0D1117]">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">Collaborate better with KanbanPro</h2>
          <p className="text-blue-200 text-lg leading-relaxed">
            Manage projects, track progress, and ship faster with your team. All in one place.
          </p>
        </div>
      </div>
    </div>
