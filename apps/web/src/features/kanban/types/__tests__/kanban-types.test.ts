...
import {
  BoardSchema, ListSchema, CardSchema, CommentSchema, LabelSchema,
  BoardMemberSchema, AttachmentSchema, ChecklistItemSchema, ActivitySchema,
  NotificationSchema, LABEL_OPTIONS, BOARD_TEMPLATES,
} from '../kanban'

describe('Zod Schemas', () => {
  describe('BoardSchema', () => {
    const valid = { id: 'b1', name: 'Test', ownerId: 'u1', lists: [], members: [], createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' }
  ...
  describe('CardSchema', () => {
    const valid = { id: 'c1', listId: 'l1', title: 'Task', position: 1, labels: [], assignees: [], comments: [], createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' }
    ...
    it('accepts optional fields', () => {
      const withOpt = { ...valid, dueDate: '2026-02-01T00:00:00Z', coverColor: '#ff0000', archived: true, description: 'desc', checklist: [], attachments: [] }
  ...
  describe('CommentSchema', () => {
    it('parses valid comment', () => {
      const c = { id: 'cm1', cardId: 'c1', userId: 'u1', userName: 'John', content: 'Nice', createdAt: '2026-01-01T00:00:00Z' }
  ...
  describe('AttachmentSchema', () => {
    it('parses valid attachment', () => {
      const a = { id: 'att1', name: 'file.pdf', url: '/uploads/file.pdf', type: 'application/pdf', createdAt: '2026-01-01T00:00:00Z' }
  ...
  describe('ActivitySchema', () => {
    it('parses valid activity', () => {
      const a = { id: 'a1', boardId: 'b1', userId: 'u1', userName: 'John', action: 'created', entityType: 'card', entityId: 'c1', createdAt: '2026-01-01T00:00:00Z' }
      expect(ActivitySchema.parse(a).action).toBe('created')
    })
    it('rejects invalid action', () => {
      expect(() => ActivitySchema.parse({ id: 'a1', boardId: 'b1', userId: 'u1', userName: 'John', action: 'invalid', entityType: 'card', entityId: 'c1', createdAt: '2026-01-01T00:00:00Z' })).toThrow()
    })
    it('rejects invalid entityType', () => {
      expect(() => ActivitySchema.parse({ id: 'a1', boardId: 'b1', userId: 'u1', userName: 'John', action: 'created', entityType: 'invalid', entityId: 'c1', createdAt: '2026-01-01T00:00:00Z' })).toThrow()
    })
  })

  describe('NotificationSchema', () => {
    it('parses valid notification', () => {
      const n = { id: 'n1', userId: 'u1', type: 'mention', message: 'Hi', read: false, createdAt: '2026-01-01T00:00:00Z' }
