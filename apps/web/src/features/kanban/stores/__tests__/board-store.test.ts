...
describe('BoardStore', () => {
  ...
  describe('label operations', () => {
    ...
    it('toggles a label off', () => {
      ...
      useBoardStore
        .getState()
        .setCurrentBoard(makeBoard({ lists: [makeList({ cards: [makeCard({ labels: [label] })] })] }));
      useBoardStore.getState().toggleLabel('c1', label);
  ...
  describe('checklist operations', () => {
    ...
    it('toggles checklist item', () => {
      ...
      useBoardStore
        .getState()
        .setCurrentBoard(makeBoard({ lists: [makeList({ cards: [makeCard({ checklist: [item] })] })] }));
  ...
  describe('assignee operations', () => {
    ...
    it('removes an assignee', () => {
      ...
      useBoardStore
        .getState()
        .setCurrentBoard(makeBoard({ lists: [makeList({ cards: [makeCard({ assignees: [member] })] })] }));
